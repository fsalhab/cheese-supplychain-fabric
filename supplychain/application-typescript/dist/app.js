...
const org1UserId = 'typescriptAppUser0';
// pre-requisites:
...
async function main() {
    try {
        ...
        try {
            ...
            console.log('\n--> Submit Transaction: createCheese, function creates a new cheese');
            await contract.submitTransaction('createCheese', 'cheeseId', 'cheeseName', 'manufacturer1', 'date');
