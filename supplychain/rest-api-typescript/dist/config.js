...
var env = __importStar(require("env-var"));
exports.ORG1 = 'Org1';
exports.ORG2 = 'Org2';
...
exports.mspIdOrg1 = env
    .get('HLF_MSP_ID_ORG1')
    .default("".concat(exports.ORG1, "MSP"))
    .example("".concat(exports.ORG1, "MSP"))
    .asString();
/**
 * The Org2 MSP ID
 */
exports.mspIdOrg2 = env
    .get('HLF_MSP_ID_ORG2')
    .default("".concat(exports.ORG2, "MSP"))
    .example("".concat(exports.ORG2, "MSP"))
    .asString();
/**
