 ...
 */
var isMaxmemoryPolicyNoeviction = function () { return __awaiter(void 0, void 0, void 0, function () {
    var redis, redisOptions, maxmemoryPolicyConfig;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, redis.config('GET', 'maxmemory-policy')];
            case 2:
                maxmemoryPolicyConfig = _a.sent();
                logger_1.logger.debug({ maxmemoryPolicyConfig: maxmemoryPolicyConfig }, 'Got maxmemory-policy config');
